...
//     return view('/admin/approveuser')->name('approveuser');
// });
...
Route::get('/viewappointment', [AppointmentController::class, 'allappointment2'])->name('view.all.appointment')->middleware('auth');
